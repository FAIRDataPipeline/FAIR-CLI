...
class RunMetadata(pydantic.BaseModel):
    ...
    script: typing.Optional[str] = pydantic.Field(
        None,
        title="script",
        description="command to execute during a run"
    )
...
class ExternalObject(pydantic.BaseModel):
    ...
    root: pydantic.AnyHttpUrl = pydantic.Field(
        ...,
        title="root of the URL",
        description="root URL for the object"
    )
    ...
    title: str = pydantic.Field(
        ...,
        title="title",
        description="full title of the object"
    )
    description: typing.Optional[str] = pydantic.Field(
        None,
    ...
    version: str = pydantic.Field(
        ...,
        title="version",
        description="object version to import as"
    )
...
class Use(pydantic.BaseModel):
    ...
    version: typing.Optional[str] = pydantic.Field(
        None,
        title="version",
        description="object version to use"
    )
...
class UserConfigModel(pydantic.BaseModel):
    ...
    registration: typing.Optional[typing.List[typing.Union[ExternalObject, Author, Namespace]]] = pydantic.Field(
        None,
        alias="register"
    )
